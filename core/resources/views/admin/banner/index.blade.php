        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.banners.create') }}" class="btn btn-primary btn-5 d-sm-inline-block">
            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                        ...
                        <div class="card-table">
                            <div class="card-header">
                                <div class="w-full row">
                                    <div class="col">
                                        <h3 class="mb-0 card-title fw-bold">Banners</h3>
                                        <p class="m-0 text-secondary">All uploaded banners</p>
                                    </div>
                                    ...
                                    <table class="table table-vcenter table-selectable">
                                            ...
                                            <tr>
                                                <th>
                                                    <button class="table-sort d-flex justify-content-between w-100"
                                                        data-sort="sort-title">Title</button>
                                                </th>
                                                <th>Image</th>
                                                <th>
                                                    <button class="table-sort d-flex justify-content-between w-100"
                                        ...
                                        <tbody class="table-tbody list">
                                            @foreach ($banners as $banner)
                                                <tr>
                                                    <td class="sort-title">{{ $banner->title }}</td>
                                                    <td>
                                                        @if($banner->banner)
                                                    ...
                                                    <td class="sort-date">{{ $banner->created_at->format('Y-m-d') }}</td>
                                                    <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form id="deleteForm" method="POST" action="">
                                                    ...
                                                    <div class="py-4 text-center modal-body">
                                                        ...
                                                        <p>Do you really want to delete this banner?<br> This action cannot be undone.</p>
                                                    </div>
                    ...
                    <script>
                        const advancedTable = {
                            headers: [
                                {"data-sort": "sort-title", name: "Title"},

...
@section('title', 'Card Variants | USHBD')
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('admin.card-variants.create') }}" class="btn btn-primary btn-5 d-sm-inline-block">
                    ...
                    <div class="card-table">
                        <div class="card-header">
                            <div class="w-full row">
                                <div class="col">
                                    <h3 class="mb-0 card-title fw-bold">Card Variants</h3>
                                    <p class="m-0 text-secondary">All uploaded card variants</p>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-vcenter table-selectable">
                                    ...
                                    <tbody class="table-tbody list">
                                        @foreach ($cardVariants as $variant)
                                            <tr>
                                                <td class="sort-name">{{ $variant->name }}</td>
                                                <td class="sort-price">${{ number_format($variant->price, 2) }}</td>
                                                <td class="sort-date">{{ $variant->created_at->format('Y-m-d') }}</td>
                                                <td>
                                                    <a href="{{ route('admin.card-variants.edit', $variant->id) }}"
                                                    ...
                                                    <button class="btn btn-danger btn-sm"
                                                        ...
                                                        data-url="{{ route('admin.card-variants.destroy', $variant->id) }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <form id="deleteForm" method="POST" action="">
                                                ...
                                                <div class="py-4 text-center modal-body">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        ...
                                                        stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                        class="mb-2 icon text-danger icon-lg">
                                                        <path d="M12 9v4"></path>
                                                        <path
                                                    ...
                                                    <p>Do you really want to delete this card variant?<br>This action cannot be undone.</p>
                                                </div>
                ...
                <script>
                    const advancedTable = {
                        headers: [
                            ...
                            {"data-sort": "sort-price", name: "Price"},
                            {"data-sort": "sort-date", name: "Created Date"}
                        ]
                    };

    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('admin.brands.create') }}" class="btn btn-primary btn-5 d-sm-inline-block">
                    ...
                    <div class="card-table">
                        <div class="card-header">
                            <div class="w-full row">
                                <div class="col">
                                    <h3 class="mb-0 card-title fw-bold">Brands</h3>
                                    <p class="m-0 text-secondary">All uploaded brands</p>
                                </div>
                                ...
                                <table class="table table-vcenter table-selectable">
                                    ...
                                    <tbody class="table-tbody list">
                                        @foreach ($brands as $brand)
                                            <tr>
                                                <td class="sort-name">{{ $brand->name }}</td>
                                                <td class="sort-date">{{ $brand->created_at->format('Y-m-d') }}</td>
                                                <td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="deleteForm" method="POST" action="">
                                                ...
                                                <div class="py-4 text-center modal-body">
                                                    ...
                                                    <p>Do you really want to delete this brand?<br>This action cannot be undone.</p>
                                                </div>

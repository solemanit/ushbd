        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.pages.create') }}" class="btn btn-primary btn-5 d-sm-inline-block">
                ...
                <div class="col-12">
                        ...
                        <div class="card-table">
                            <div class="card-header">
                                <div class="w-full row">
                                    <div class="col">
                                        <h3 class="mb-0 card-title fw-bold">Pages</h3>
                                        <p class="m-0 text-secondary">All created pages</p>
                                    </div>
                                    <div class="col-md-auto col-sm-12">
                                        <div class="flex-wrap d-flex btn-list ms-auto">
                            ...
                            <div id="advanced-table">
                                <div class="table-responsive">
                                    <table class="table table-vcenter table-selectable">
                                        <thead>
                                            <tr>
                                                <th><button class="table-sort d-flex justify-content-between w-100" data-sort="sort-title">Page Title</button></th>
                                                <th>Show In Menu</th>
                                        ...
                                        <tbody class="table-tbody list">
                                            @foreach ($pages as $page)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($page->menu_visible)
                                                            <span class="badge bg-green">Yes</span>
                                                        @else
                                                            <span class="badge bg-secondary">No</span>
                                                        @endif
                                                    </td>
                                                    <td class="sort-date">{{ $page->created_at->format('Y-m-d') }}</td>
                                                    <td>
                                                        ...
                                                        <button class="btn btn-danger btn-sm"
                                                                ...
                                                                data-url="{{ route('admin.pages.destroy', $page->id) }}">
                                                            Delete
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            document.querySelector("#advanced-table-search").addEventListener("input", (e) => list.search(e.target.value));
                        });
                    </script>

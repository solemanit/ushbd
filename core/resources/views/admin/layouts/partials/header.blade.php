            ...
            <div class="flex-row navbar-nav order-md-last">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        <a href="{{ route('admin.profile.edit', ['admin' => auth('admin')->id()]) }}" class="dropdown-item">My Profile</a>
                        <!-- Authentication -->
                        <form method="POST" action="{{ route('admin.logout') }}">
                            @csrf
                            <a href="route('admin.logout')" onclick="event.preventDefault(); this.closest('form').submit();" class="dropdown-item">{{ __('Logout') }}</a>
                        </form>
                    </div>
                </div>
            </div>

          ...
          <span class="navbar-brand"><a href="{{ url('/') }}" style="background: transparent;"><svg class="brand-logo"
                      ...
                      <switch>
                          <g>
                              ...
                              <path fill="#2DA0DA"
                                  d="M2.8 25.1V4.6a9.6 9.6 0 0 1 9.6 9.6v10.9c0 3.4 1.6 6.5 4.2 8.4 1.8 1.4 4 2.2 6.5 2.2h.1c5.4 0 9.8-4 10.5-9.2.9.2 1.8.3 2.8.3 2.6 0 5-.8 6.9-2.3v.4A20.4 20.4 0 0 1 9.6 40.3l-1-.9a20.6 20.6 0 0 1-5.8-14.3z" />
                          </g>
                      </switch>
                  </svg></a></span>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar">
      <div class="offcanvas-header">
          <a href="{{ url('/') }}" style="background: transparent;"><svg class="brand-logo"
                  xmlns="http://www.w3.org/2000/svg" xml:space="preserve" baseProfile="tiny" overflow="visible"
                  version="1.2" viewBox="0 0 197.9 50">
                  <switch>
                      <g>
      ...
      <div class="p-0 offcanvas-body">
          <!-- Sidebar (Mobile) -->
          <div class="shadow-sm dashboard-sidebar-mob dash-nav-desk">
              <h6>Learn</h6>
              <a href="#" class="active"><i class="fa-light fa-book me-2"></i>My Courses</a>
              <a href="#"><i class="fa-light fa-folders me-2"></i>Resources</a>
              <a href="#"><i class="fa-light fa-star me-2"></i>Ratings</a>
              <a href="#"><i class="fa-light fa-award me-2"></i>Certificates</a>
              <a href="#"><i class="fa-light fa-briefcase me-2"></i>Job Search</a>
              <h6>Settings</h6>
              <a href="#"><i class="fa-light fa-user-edit me-2"></i>Profile</a>
              <form method="POST" action="{{ route('logout') }}" id="logout-form">
                  @csrf
                  <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                      <i class="fa-light fa-sign-out-alt me-2"></i> Log Out
                  </a>
              </form>
          </div>
      </div>
